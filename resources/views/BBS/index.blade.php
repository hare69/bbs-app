...
<ul class="navbar-nav ms-auto">
    ...
    <div class="w-11/12 max-w-screen-md m-auto">
        ...
        {{-- スレ作成 --}}
        <div class="flex justify-end mt-2">
        <a href="{{ url('/thread') }}"><input class="my-2 px-2 py-1 rounded bg-blue-300 text-blue-900 font-bold link-hover cursor-pointer" type="submit" value="スレ作成"></a>
                </div>
            </form>
        </div>
        {{-- 検索 --}}
        <div class="flex justify-end mt-2">
        <a href="{{ url('/thread') }}"><input class="my-2 px-2 py-1 rounded bg-blue-300 text-blue-900 font-bold link-hover cursor-pointer" type="submit" value="検索"></a>
                </div>
            </form>
        </div>
